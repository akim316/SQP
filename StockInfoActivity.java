...
public class StockInfoActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		yearLowTextView = (TextView) findViewById(R.id.bidTextView);
		yearHighTextView = (TextView) findViewById(R.id.askTextView);
		daysLowTextView = (TextView) findViewById(R.id.prevCloseTextView);
		daysHighTextView = (TextView) findViewById(R.id.openTextView);
		lastTradePriceOnlyTextView = (TextView) findViewById(R.id.volumeTextView);
		changeTextView = (TextView) findViewById(R.id.marketCapTextView);
